...
import { Button, Form, Container, Header, Flag } from "semantic-ui-react";
...
function AddRecord(props) {
  ...
  const [url, setUrl] = useState(
    "https://script.google.com/macros/s/AKfycbzsLrukKDQcvRu4J1SzrD5M7cyyftPF7YVjsxef5d996V3B9Px4cxnNFZx0a0yeUVEA/exec?type=add&id=0"
  );
  ...
  return (
    <Container fluid className="container-m">
      <Header as="h2">Add Record</Header>
